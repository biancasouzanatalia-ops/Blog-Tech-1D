...
botoes.forEach(function (botao) {
    ...
    function botaoClicado() {
        // Exibe uma mensagem no console do navegador apenas para testar se o clique funciona
        console.log("fui clicado");

        // Procura e seleciona a tag <span> (o número do contador) que está dentro deste botão
        let texto = botao.querySelector("span");

        // Se o usuário ainda não tiver clicado neste botão (curtiu igual a false)
        if (curtiu === false) {
